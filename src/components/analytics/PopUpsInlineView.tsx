...
interface PopUpsInlineViewProps {
  onBack: () => void;
}

export function PopUpsInlineView({ onBack }: PopUpsInlineViewProps) {
  ...
  const gotSoleEndDate = new Date('2025-01-11');
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between no-print">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <Label htmlFor="edit-mode-inline" className="flex items-center gap-1 cursor-pointer">
