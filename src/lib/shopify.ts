...
export const SHOPIFY_STORE_PERMANENT_DOMAIN = 'wallst-collection-ux2t9.myshopify.com';
export const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
export const SHOPIFY_STOREFRONT_TOKEN = '9aff8abf568457dc5ca2f0c252dca568';
